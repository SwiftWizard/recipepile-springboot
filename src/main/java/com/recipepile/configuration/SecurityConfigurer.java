...
import com.recipepile.filters.JwtRequestFilters;
import com.recipepile.services.MyUserDetailsService;
        ...
        return new WebMvcConfigurer() {
            ...
            public void addCorsMappings(CorsRegistry registry) {
                registry.addMapping("/api/**")
                        .allowedOrigins("https://recipepile.online", "http://localhost:4200")
                        .allowedHeaders("*")
                        .allowedMethods("*")
